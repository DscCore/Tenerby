...
bool ChatHandler::HandleServerInfoCommand(const char* /*args*/)
{
	...
	PSendSysMessage("Revision 2.0 Project by Airus Special for WoW TiMe");
	PSendSysMessage("YTDB 635, Linux Debian 6");
	PSendSysMessage("Skype Administrators - borisovki88");
